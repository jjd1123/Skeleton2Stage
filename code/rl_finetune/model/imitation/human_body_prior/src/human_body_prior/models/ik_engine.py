...
try:
    ...
    from human_body_prior.src.human_body_prior.tools.omni_tools import log2file
    from human_body_prior.src.human_body_prior.models.vposer_model import VPoser
    from human_body_prior.src.human_body_prior.tools.omni_tools import flatten_list
