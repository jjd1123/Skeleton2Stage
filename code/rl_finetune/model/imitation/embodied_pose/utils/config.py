...
def load_cfg(args):
    ...
    cfg_path = f'{ROOT_PATH}/embodied_pose/cfg/**/{args.cfg}.yaml'
    ...
    seed = cfg_train["params"].get("seed", None)
...
def get_args(benchmark=False,device=None):
    #change to hard code
    custom_parameters = [
        {"name": "--test", "action": "store_false", "default": True,
        ...
        {"name": "--checkpoint", "type": str, "default": "epoch20000",
        ...
        {"name": "--results_dir", "type": str, "default": f"./{ROOT_PATH}/results"},
        ...
        {"name": "--cfg", "type": str, "default": "amass_im", "help": "all-in-one configuration file (.yaml)"},
        ...
        # {"name": "--dataset", "type":str, "default": "humanml"},
        # {"name": "--save_dir", "type": str, "default": "save/my_humanml_trans_enc_512"},
        # {"name": "--resume_checkpoint", "type": str, "default": None},
        # {"name": "--music_dir", "type":str, "default":"data/music"},
        # {"name": "--save_motions", "action": "store_true", "default": False},
        # {"name": "--motion_save_dir", "type": str, "default": "save"},
        # {"name": "--cache_features", "action": "store_true", "default": False},
        # {"name": "--use_cached_features", "action": "store_true", "default": False},
        # {"name": "--feature_cache_dir", "type": str, "default": "cached_features"},
        {"name": "--config","type":str,"default":None},
        {"name": "--train", "action": "store_true","default": False},
        {"name": "--batch_size","type":int,"default":128},
        {"name": "--epochs","type":int,"default":100},
        {"name": "--feature_type","type":str,"default":None},
        {"name": "--exp_name","type":str},
        {"name": "--render_dir","type":str},
        {"name": "--save_motions","action":"store_true","default":False},
        {"name": "--motion_save_dir","type":str},
        {"name": "--use_cached_features","action":"store_true","default":False},
        {"name": "--feature_cache_dir","type":str},
    ]
    ...
    args = gymutil.parse_arguments(
        ...
        custom_parameters=custom_parameters,device=device)
    if device!=None:
        args.rl_device = str(device)
    # alignment with examples
    if args.resume_id is not None:
        args.resume = True
    args.sim_device = args.rl_device
    if args.use_gpu_pipeline:
        args.compute_device_id = int(args.rl_device[-1] if args.rl_device!="cuda" else 0)
        args.graphics_device_id = int(args.rl_device[-1] if args.rl_device!="cuda" else 0)
...
def get_train_args(benchmark=False,device=None):
    #change to hard code
    custom_parameters = [
        ...
        {"name": "--resume", "action": "store_true", "default": False,
            "help": "Resume training or start testing from a checkpoint"},
        {"name": "--resume_id", "type": str, "default": None},
        {"name": "--checkpoint", "type": str, "default": "latest",
            "help": "Path to the saved weights, only for rl_games RL library"},
        {"name": "--headless", "action": "store_false", "default": True,
            "help": "Force display off at all times"},
        {"name": "--horovod", "action": "store_true", "default": False,
        ...
        {"name": "--metadata", "action": "store_true", "default": False,
            "help": "Requires --experiment flag, adds physics engine, sim device, pipeline info and if domain randomization is used to the experiment name provided by user"},
        {"name": "--cfg", "type": str, "default": "amass_im_fit", "help": "all-in-one configuration file (.yaml)"},
        {"name": "--num_envs", "type": int, "default": 0,
            "help": "Number of environments to create - override config file"},
        {"name": "--episode_length", "type": int, "default": 0,
            "help": "Episode length, by default is read from yaml config"},
