...
if __name__ == "__main__":
    ...
    # real_features = {
    #     "kinetic": [np.load(f) for f in glob.glob("/workspace/jja3wx/popdg_dataprocess/popdanceset/motions/features/*_kinetic.npy")],
    #     "manual": [np.load(f) for f in glob.glob("/workspace/jja3wx/popdg_dataprocess/popdanceset/motions/features/*_manual.npy")],
    # }
    # get motion features for the results
    result_features = {"kinetic": [], "manual": []}
    path = "/workspace/jja3wx/jidong/EDGE/runs/simple_loss_20_485_meanfgc-2000"
    # path = "/workspace/jja3wx/jidong/EDGE/runs/newfgc_per_frame_20_50_155_150_axisz_0509_mean-1500"
    print(path)
    result_files = glob.glob(f'{path}/*.pkl')
