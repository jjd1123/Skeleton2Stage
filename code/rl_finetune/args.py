...
def parse_train_opt():
    ...
    parser.add_argument("--data_path", type=str, default= f"{prefix}/data/", help="raw data path")
    parser.add_argument(
        "--processed_data_dir",
        type=str,
        default= f"{prefix}/data/dataset_backups/",
    ...
    parser.add_argument(
        "--wandb_pj_name", type=str, default="rl_EDGE_v100", help="project name"
    )
...
def parse_test_opt():
    parser = argparse.ArgumentParser()
    parser.add_argument("--feature_type", type=str, default="jukebox")
    parser.add_argument("--out_length", type=float, default=20, help="max. length of output, in seconds")
    parser.add_argument(
        "--processed_data_dir",
        type=str,
