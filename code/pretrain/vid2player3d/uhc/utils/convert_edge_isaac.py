...
parser.add_argument('--edge_data', type=str, default="/mnt/Nerf001/jidong/EDGE/data/dataset_backups/processed_train_data.pkl")
parser.add_argument('--out_dir', type=str, default="data/motion_lib/edge/")
...
edge_data = joblib.load(args.edge_data)
