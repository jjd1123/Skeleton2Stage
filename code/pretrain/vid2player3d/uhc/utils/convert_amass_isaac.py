...
parser.add_argument('--amass_data', type=str, default="../UniversalHumanoidControl/sample_data/amass_copycat_take5_test.pkl")
parser.add_argument('--out_dir', type=str, default="data/motion_lib/amass_test")
