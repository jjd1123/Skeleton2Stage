...
import torch
from env.tasks.humanoid_smpl_im import HumanoidSMPL, dof_to_obs
from env.tasks.humanoid_smpl_im_vis import HumanoidSMPLIM
...
class HumanoidSMPLMDMIM(HumanoidSMPLIM):
    ...
    def _reset_ref_state_init(self, env_ids):
        ...
        self._resample_amass_motions()# To load new motions
