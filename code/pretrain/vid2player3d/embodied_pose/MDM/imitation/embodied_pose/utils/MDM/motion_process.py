...
from embodied_pose.utils.MDM.quaternion import *
from embodied_pose.utils.MDM.paramUtil import *
import torch

# positions (batch, joint_num, 3)
def uniform_skeleton(positions, target_offset, face_joint_indx, l_idx1, l_idx2,src_skel):
...
def process_file(positions, feet_thre, tgt_offsets, face_joint_indx,fid_l,fid_r,n_raw_offsets, kinematic_chain,skeleton):
    # (seq_len, joints_num, 3)
    #     '''Down Sample'''
    #     positions = positions[::ds_num]

    '''Uniform Skeleton'''
    positions = uniform_skeleton(positions, tgt_offsets,face_joint_indx,5,8,skeleton)
