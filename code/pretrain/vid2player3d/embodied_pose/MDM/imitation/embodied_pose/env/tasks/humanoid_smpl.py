...
import torch
from embodied_pose.env.tasks.base_task import BaseTask
...
class HumanoidSMPL(BaseTask):
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        self.resample_interval = self.cfg["env"].get("resample_interval",1)
        self.multi_process = self.cfg["env"].get("multi_process",False)
    ...
    def _setup_tensors(self):
        ...
        self._rigid_body_pos = rigid_body_state_reshaped[..., :self.num_bodies, 0:3] #position
        self._rigid_body_rot = rigid_body_state_reshaped[..., :self.num_bodies, 3:7] #rotation
        self._rigid_body_vel = rigid_body_state_reshaped[..., :self.num_bodies, 7:10] #velocity
        self._rigid_body_ang_vel = rigid_body_state_reshaped[..., :self.num_bodies, 10:13] #angular_velocity
    ...
    def _load_amass_gender_betas(self):
        import joblib
        gender_betas_data = joblib.load("data/motion_lib/amass/shape_data.pkl")
        self._amass_beta_array = gender_betas_data['beta_arr']
        self._amass_beta_map = gender_betas_data['beta_mapping']
