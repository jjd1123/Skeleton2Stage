...
try:
    ...
    from human_body_prior.src.human_body_prior.models.model_components import BatchFlatten
    from human_body_prior.src.human_body_prior.tools.rotation_tools import matrot2aa
